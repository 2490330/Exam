				...
				<c:when test="${user.isAuthenticated()}">
					<nav class="col-3">
						...
						<ul class="nav nav-pills flex-column mb-auto px-4">
							<li class="nav-item my-3"><a href="/teamD/scoremanager/main/Menu.action">メニュー</a></li>
							<li class="nav-item mb-3"><a href="/teamD/scoremanager/main/StudentList.action">学生管理</a></li>
							<li class="nav-item">成績管理</li>
							<li class="nav-item mx-3 mb-3"><a href="/teamD/scoremanager/main/TestRegist.action">成績登録</a></li>
							<li class="nav-item mx-3 mb-3"><a href="/teamD/scoremanager/main/TestList.action">成績参照</a></li>
							<li class="nav-item mb-3"><a href="/teamD/scoremanager/main/SubjectList.action">科目管理</a></li>
							<li class="nav-item mb-3"><a href="/teamD/scoremanager/main/ClassList.action">クラス管理</a></li>
						</ul>
